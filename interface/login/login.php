        ...
        <form method="POST" id="login_form" autocomplete="off"
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div>
						<div>
                        <div class="center-block" style="max-width:500px; display: flex; flex-direction:row; justify-content:space-between">
                            <img class="center-right" style="width: 300px" src="<?php echo $GLOBALS['images_static_relative']; ?>/login-logo.png" />							
                            <img class="center-left" style="width:100px" src="<?php echo $GLOBALS['images_static_relative']; ?>/uaem.png" />
                        </div>
